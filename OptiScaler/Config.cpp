...
bool Config::Reload(std::filesystem::path iniPath)
{
    ...
    if (ini.LoadFile(iniPath.c_str()) == SI_OK)
    {
...

        {
            ...
            FGXeFGIgnoreMaxInterpolations.set_from_config(readBool("XeFG", "IgnoreMaxInterpolations"));
...
bool Config::SaveIni()
{
    ...
    // XeFG output
    {
        ...
        ini.SetValue("XeFG", "IgnoreMaxInterpolations",
                     GetBoolValue(Instance()->FGXeFGIgnoreMaxInterpolations.value_for_config()).c_str());
